...
const actions = {
  ...
  applyCoupon(code) {
    const codes = { SAVE10: 0.1, FRESH20: 0.2, WELCOME5: 0.05 };
  ...
  upsertProduct(data, editingId) {
    setState((s) => {
      ...
      const sku = data.cat.toUpperCase().slice(0, 3) + "-" + String(s.products.length + 1).padStart(3, "0");
      return {
        ...s,
...
const CATEGORIES = ["All", "Fruits", "Vegetables", "Dairy", "Grains", "Beverages", "Snacks"];
export {
  CATEGORIES as C,
  actions as a,
  useStore as u
